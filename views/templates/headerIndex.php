            ...
            <div class="nav-right">
                ...
                <?php
                            if(isset($_SESSION['email'])){
                                ...
                                <a href="views/logout.php"><span class="nav-item nav-user" style="height: 36px;">
                ...
                <a href="views/search.php"><span class="nav-item nav-search"><i class="fas fa-search fa-lg"></i>
